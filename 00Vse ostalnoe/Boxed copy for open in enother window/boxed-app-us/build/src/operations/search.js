            ...
            const skus = products === null || products === void 0 ? void 0 : products.productListEntities.map((product) => {
                ...
                const sku = {
                    ...
                    extract: {
                        timestamp,
                        name: product.name,
                        brand: (_a = product.variantObject) === null || _a === void 0 ? void 0 : _a.brandingText,
                        description: (_b = product.variantObject) === null || _b === void 0 ? void 0 : _b.longDescription,
                        price: (_c = product.inventory) === null || _c === void 0 ? void 0 : _c.map((x) => x.price),
                    },
                    parsed: {
