...
exports.detail = gather_sdk_1.CrawlOperation.detail({
    ...
    sku: {
        execute: async (ctx) => {
            ...
            const skus = products === null || products === void 0 ? void 0 : products.variants.map((product) => {
                const sku = {
                    ...
                    gather: {
                        timestamp,
                        url: `https://api.boxed.com/v1/productByVariant/${products === null || products === void 0 ? void 0 : products._id}?v=2.6&deviceId=8af07f5a-e031-4d12-9ff1-f4f5c9095426&appVersion=2.7.5&accessToken=NzZkZGE3ZTBiN2Y2NDgxYzJkNTFmZjBkNjI1ZjM4NDE5YjE4MzA3Nw%3D%3D&postalCode=07030`,
                    },
                    extract: {
                        timestamp,
